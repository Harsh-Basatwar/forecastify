  ...
  return (
    <div id="jarvis-pdf-report" className="hidden print:block absolute inset-0 bg-white text-black p-12 z-[9999]">
      ...
      <div className="h-[250mm] flex flex-col items-center justify-center text-center">
        <h1 className="text-5xl font-black text-cyan-700 mb-6">J.A.R.V.I.S.</h1>
      ...
      {reportHtml ? (
        <div 
          className="mb-12 prose prose-cyan max-w-none prose-h2:text-2xl prose-h2:font-bold prose-h2:text-cyan-800 prose-h2:border-b-2 prose-h2:border-cyan-100 prose-h2:pb-2 prose-h2:mb-6"
        ...
        <>
          {/* Overview & Summaries */}
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-cyan-800 border-b-2 border-cyan-100 pb-2 mb-6">Store Overview</h2>
          ...
          {/* Low Stock & Expiry */}
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-cyan-800 border-b-2 border-cyan-100 pb-2 mb-6">Risk Alerts</h2>
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="p-3 border-b border-gray-100 text-blue-600 font-medium">Overstock</td>
          ...
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-cyan-800 border-b-2 border-cyan-100 pb-2 mb-6">AI Demand Forecast & Impact</h2>
            <div className="p-6 bg-blue-50 text-blue-900 rounded-xl mb-6">
              <h3 className="font-bold mb-2 text-blue-800">Weather Notice: Heavy Rain Expected</h3>
          ...
          {/* Executive Summary */}
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-cyan-800 border-b-2 border-cyan-100 pb-2 mb-6">Jarvis Executive Summary</h2>
